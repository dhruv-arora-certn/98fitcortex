...
from workout.views import WarmupView , StretchingView , CoolDownView ,\
		...
		CustomerInjuryView, GenerateWorkoutView , RegenerableWorkoutView
...
urlpatterns = [
	...
	re_path(r'^workoutplan-regenerable/(?P<year>(2017|2018))/(?P<week_id>[0-9]+)/day/(?P<day>[1-7])/$' , RegenerableWorkoutView.as_view()),
