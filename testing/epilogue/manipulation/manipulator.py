...
class DummyFood:
	...
	'''
	def __init__(self , id , name , size , weight , squared_diff_weight_loss , squared_diff_weight_gain , squared_diff_weight_maintain , calorie , protein , fat , carbohydrates):
		self.id = id
		self.name = name
		self.size = size
		self.weight = weight
