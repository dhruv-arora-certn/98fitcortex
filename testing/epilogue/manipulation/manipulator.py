...
class Manipulator():
    ...
    def categorize(self):
        '''
        Partition self.items into categories 
        '''
    ...
    def types(self):
        '''
        Return all the categories identified
        '''
    ...
    def query_string(self , ids , type_):
        '''
        Generate the query string based on `ids` of food items
        and the type
        '''
        string = '''
        select 
    ...
    def cross_join(self):
        '''
        Implement the cross join of food items and their valid sizes.
    ...
    def iter_objs(self):
        '''
        Package the tuples returned from `cross_join` into `DummyFood`
        '''
